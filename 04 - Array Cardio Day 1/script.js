...
const selection3 = inventors.sort((a, b) => a.year > b.year ? 1 : -1)
...
const selection5 = inventors.sort(function(a, b) {
...
const selection7 = people.sort((a, b) => {
...
const selection8 = data.reduce(function(obj, item) {
    if(!obj[item])  {
        obj[item] = 0
    }
    obj[item]++
